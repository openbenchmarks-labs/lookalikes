"""Ocean.io runner — thin binding to specs/ocean.yaml + generic runner.

Fully declarative: request body, the company-sub-object field mapping, and the
config-filter deep-merge are all in the spec; no Python hooks.
"""
