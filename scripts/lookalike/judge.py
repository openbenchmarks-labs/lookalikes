...
Uses the OpenAI Python SDK with `base_url` overridden to the
Azure-hosted gpt-5 deployment — same pattern as the self-serve-backend
LLM modules (e.g. `llm/industry_match.py`).
